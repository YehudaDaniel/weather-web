...
const forecast = (latitude, longitude, callback) => {
    ...
    request( { url, json: true}, (err, { body }) => {
        if(err){
            ...
            callback(undefined, body.current.weather_descriptions[0] + '. It is ' + body.current.temperature + ' degrees out, but feels like ' + body.current.feelslike + ' degrees. the Humidity is '+body.current.humidity);
        }
    });
